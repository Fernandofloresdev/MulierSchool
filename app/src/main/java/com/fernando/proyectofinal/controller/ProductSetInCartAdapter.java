...
public class ProductSetInCartAdapter extends RecyclerView.Adapter<ProductSetInCartAdapter.ViewHolder>{
    ...
    public ProductSetInCartAdapter(Context mContext, List<Product> productInCartList){
    ...
    @Override
    public ProductSetInCartAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
